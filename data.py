all_data = {
    "construction": {
        ...
        "roadmap": [
            {
                "step": "१. हेल्पर से शुरुआत करें",
                "desc": "निर्माण साइट पर सामान, सीमेंट और सामग्री की बुनियादी समझ हासिल करें।"
            },
            {
                "step": "२. राजमिस्त्री का काम सीखें",
                "desc": "दीवार बनाना, प्लास्टर करना और टाइल्स लगाने जैसी कुशल तकनीकों को सीखें।"
            },
            {
                "step": "३. ड्राइंग पढ़ना और सुपरवाइजिंग सीखें",
                "desc": "एआई टूल या साइट इंजीनियर की मदद से नक्शा पढ़ना सीखें और सुपरवाइजर बन कर दोगुनी कमाई करें।"
            }
        ]
    },
    ...
    "factory": {
        ...
        "roadmap": [
            {
                "step": "१. सुरक्षा नियम और टूल्स समझें",
                "desc": "फैक्ट्री में सुरक्षात्मक उपकरण पहनना और बुनियादी मशीन ऑपरेशन्स समझें।"
            },
            {
                "step": "२. कंप्यूटर या मशीन कंट्रोल सीखें",
                "desc": "मैन्युअल से ऑटोमैटिक मशीन कंट्रोल यूनिट्स की बुनियादी सेटिंग्स को चलाना सीखें।"
            },
            {
                "step": "३. CNC प्रोग्रामिंग या क्वालिटी चेक कोर्स",
                "desc": "ऑनलाइन या संस्थान से 3 महीने की ट्रेनिंग लेकर स्किल्ड ऑपरेटर बनें।"
            }
        ]
    },
    ...
    "electrical": {
        ...
        "roadmap": [
            {
                "step": "१. घरेलू वायरिंग और सुरक्षा नियम सीखें",
                "desc": "सिंगल-फेज वायरिंग, अर्थिंग और सेफ्टी टूल्स का सही उपयोग सीखें।"
            },
            {
                "step": "२. स्मार्ट अप्लायंस रिपेयरिंग सीखें",
                "desc": "आधुनिक इन्वर्टर, स्मार्ट फैन और गीजर की सर्किट टेस्टिंग और डायग्नोस्टिक्स सीखें।"
            },
            {
                "step": "३. सोलर पैनल इंस्टॉलेशन (भविष्य का काम)",
                "desc": "सोलर पैनल लगाने और उनकी बैटरी ग्रिड को जोड़ने का कोर्स करें, इसकी मांग बहुत तेजी से बढ़ रही है।"
            }
        ]
    },
    ...
    "plumbing": {
        ...
        "roadmap": [
            {
                "step": "१. पाइप मटेरियल और फिटिंग सीखें",
                "desc": "PVC, GI और CPVC पाइपों की कटिंग, थ्रेडिंग और बुनियादी जॉइंट्स बनाना सीखें।"
            },
            {
                "step": "२. लेआउट और आधुनिक फिटिंग समझें",
                "desc": "बाथरूम और किचन में वाटर प्रेशर लाइनों का लेआउट बनाना और मॉडर्न कमोड/सिंक फिटिंग सीखें।"
            },
            {
                "step": "३. ऑटोमेशन और पंप रिपेयरिंग",
                "desc": "प्रेशर पंप, वाटर प्यूरीफायर और ऑटोमैटिक सेंसर नलों का काम सीखकर खुद का स्वतंत्र काम शुरू करें।"
            }
        ]
    },
    ...
    "domestic": {
        ...
        "roadmap": [
            {
                "step": "१. स्मार्टफोन और नेविगेशन का उपयोग सीखें",
                "desc": "गूगल मैप्स (Google Maps) चलाना और डिजिटल पेमेंट रिसीव करना सीखें।"
            },
            {
                "step": "२. कंप्यूटर और सुरक्षा प्रणालियों की ट्रेनिंग लें",
                "desc": "सोसायटियों में उपयोग होने वाले एंट्री ऐप्स (जैसे MyGate/NoBrokerHood) की ट्रेनिंग लें।"
            },
            {
                "step": "३. लॉजिस्टिक्स या सुपरवाइजर कोर्स करें",
                "desc": "वेयरहाउस ऑपरेशन्स, बिल मेकिंग और स्टोर सुपरवाइजिंग सीखकर ऊंची सैलरी पाएं।"
            }
        ]
    },
    ...
    "other": {
        ...
        "roadmap": [
            {
                "step": "१. बुनियादी डिजिटल साक्षरता सीखें",
                "desc": "यूपीआई (UPI) पेमेंट लेना, बिल बनाना और व्हाट्सएप पर डॉक्यूमेंट शेयर करना सीखें।"
            },
            {
                "step": "२. कंप्यूटर और डेटा एंट्री सीखें",
                "desc": "एमएस एक्सेल (MS Excel) और बुनियादी टाइपिंग सीखें जो हर दफ्तर में काम आती है।"
            },
            {
                "step": "३. सुपरवाइजर या सेल्स स्किल डेवलप करें",
                "desc": "गले पर बैठना, कस्टमर डीलिंग और दुकान की देखभाल करना सीखकर मैनेजर स्तर पर बढ़ें।"
            }
        ]
    }
}