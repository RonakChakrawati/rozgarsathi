...
document.getElementById('search-form').addEventListener('submit', function(e) {
  ...
  const skillVal = document.getElementById('skill-input').value.trim();
  ...
  if (!skillVal || !locationVal || !categoryVal) {
  ...
  setTimeout(() => {
    ...
    data.jobs.forEach((job, index) => {
      // Customize location in job description
      ...
      const waJobUrl = `https://wa.me/919999999999?text=${waJobText}`;
    ...
    data.schemes.forEach((scheme, index) => {
      ...
      const waSchemeUrl = `https://wa.me/919999999999?text=${waSchemeText}`;
    ...
    const waAllUrl = `https://wa.me/919999999999?text=${waAllText}`;
